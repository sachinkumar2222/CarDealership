...
//        val currentAccount = account ?: return Result.failure(IllegalStateException("No account signed in"))
//        val app = getMsalApp()
//
//        return suspendCoroutine { continuation ->
//            val scopes = listOf(
...
//        return try {
//            val currentAccount = account ?: return Result.success(Unit) // Already signed out
//            val app = getMsalApp()
//
